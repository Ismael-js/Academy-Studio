...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    .setName('claim')
    .setDescription('Claim a ticket | Reclama un ticket.')
  ...
  async execute(interaction) {
    ...
    if (config.claimFeature === false) {
      return interaction.reply({
        content: 'The claim feature is currently disabled. | La función de reclamar está desactivada.',
        ephemeral: true,
      });
    }
    ...
    if (claimStatus) {
      return interaction.reply({
        content: `This ticket has already been claimed by <@!${claimUser}> | Este ticket ya esta reclamado por <@!${claimUser}>`,
        ephemeral: true,
      });
    }
