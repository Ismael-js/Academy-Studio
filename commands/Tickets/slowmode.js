...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    .setName('slowmode')
    .setDescription('Add slowmode to a ticket channel. | Añadir modo lento a un canal de tickets.')
    ...
    .addIntegerOption((option) =>
      option
        .setName('time')
        .setDescription('Input a time in seconds | Ingresa un tiempo en segundos')
        .setRequired(true)
        .setMaxValue(21600),
    )
